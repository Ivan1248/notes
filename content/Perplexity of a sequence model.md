...
$$
\operatorname{PPP}(p) = \exp(-n^{-1}\ln(\P(x_1, .., x_n))) = \P(x_1, .., x_n)^{-1/n}  \text.
$$
...
$$
\operatorname{PPP}(p) = \exp\left(\frac{1}{n}\left(-\ln(\P(x_1))-\sum_{i=2}^n\ln(\P(x_i\mid x_1, .., x_{i-1}))\right)\right) \text.
$$
